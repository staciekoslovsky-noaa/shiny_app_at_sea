# Shiny App for At-sea Distribution of Marine Mammals (AS-MAP)

Project Leads: Paul Conn and Stacie Koslovsky <br>
Application Development: Haley Faucher (NOAA LaPenta intern, 2026); Christine Kwon (UChicago intern, summer 2024) <br>
...
* **hfaucher_log.md** - documentation and information from Haley Faucher's internship
